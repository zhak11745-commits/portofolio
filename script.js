document.addEventListener('DOMContentLoaded', () => {
  ...
  // Objek unit suhu dan formula konversinya ke basis (Celsius)
  const UNITS = {
  ...
  function populateSelects() {
    // Fungsi ini mengisi dropdown dari objek UNITS
  ...
  copyBtn && copyBtn.addEventListener('click', () => {
    const txt = resultValue.textContent.split(' ')[0];
  ...
  // Inisialisasi: Panggil populateSelects() di sini
  populateSelects();
